...
multihetsep_bootstrap.py -n $7 -s $8 --chunks_per_chromosome $9 --nr_chromosomes 3  $6/boot $6/$6.NC_035107.1.multihetsep.txt $6/$6.NC_035108.1.multihetsep.txt $6/$6.NC_035109.1.multihetsep.txt
