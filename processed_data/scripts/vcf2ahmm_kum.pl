...
my $rec_rate = 2.5e-9 ;            ### average per bp recombination rate in morgans
my $min_f_diff = 0.3 ;           ### minimum frequency difference between reference populations
